      ...
      <article className="section-3-container" >
        <section>
          ...
          <p className="pop-font section-description">
            Bento Delivaz  provides services across all states - various foods and
        ...
        <section className="services-grid   flexy">
          {ourServices.map((service) => (
            <Tilt key={service.id}>
              <section className="service-list flex-container flex-column flexy">
                <img
                  width="50"
                  height="50"
